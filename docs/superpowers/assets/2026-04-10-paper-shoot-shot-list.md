# Paper Shoot Commercial Art Shot List (Placeholder Replacement)

This list defines the final generated art shots that will replace the current placeholder SVG shell assets.
